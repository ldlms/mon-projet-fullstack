...
deckRouter.delete("/:deckId/cards/:cardId", authMiddleware, deckController.removeCardFromDeck)

deckRouter.post("/:deckId/cards/:cardId",authMiddleware, deckController.addCardToDeck)
